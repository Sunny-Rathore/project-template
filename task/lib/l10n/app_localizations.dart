...
abstract class AppLocalizations {
  ...
  /// No description provided for @confirmContinueTxt.
  ///
  /// In en, this message translates to:
  /// **'Confirm & Continue'**
  String get confirmContinueTxt;
  ...
  /// No description provided for @weHaveSend.
  ///
  /// In en, this message translates to:
  /// **'We have sent an OTP to'**
  String get weHaveSend;
  ...
  /// No description provided for @congratulationsYouAre.
  ///
  /// In en, this message translates to:
  /// **'Congratulations you\'re now an Agent of change'**
  String get congratulationsYouAre;
}
