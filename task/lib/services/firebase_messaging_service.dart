...
//       navigatorKey.currentState?.pushNamed(AppRoutes.chatInboxScreen, arguments: message.data['id']);
//     });
...
//           navigatorKey.currentState?.pushReplacementNamed(AppRoutes.chatInboxScreen, arguments: message.data['id']);
//         });
//       }
//     });
//   }
...
//   static const String fcmEndpoint = 'https://fcm.googleapis.com/v1/projects/$projectNumber/messages:send';
//   static const String serviceAccountPath = 'assets/json/laizanew-33d585212b5e.json';
//
...
//       } else {
//         debugPrint('Notification sending failed with code: ${response.statusCode}.');
//       }
//     } catch (e) {
//       if (e is DioException) {
//         debugPrint('Error: ${e.response?.data}'); // Log detailed error information
//       } else {
...
//     final jsonString = await rootBundle.loadString('assets/json/laizanew-33d585212b5e.json');
...
//     var notifyToken = await FirebaseMessaging.instance.isSupported() ? await FirebaseMessaging.instance.getToken() : "notifyToken";
