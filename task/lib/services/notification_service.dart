...
//   static const AndroidInitializationSettings _initializationSettingsAndroid = AndroidInitializationSettings('@mipmap/notification_icon');
//
...
//     presentSound: true,
//   );
//   static const NotificationDetails _notificationDetails = NotificationDetails(android: _androidNotificationDetails, iOS: _iosNotificationDetails);
//
// // Android-specific callback for when a notification is received
//
//   static void _onDidReceiveLocalNotification(NotificationResponse notificationResponse) async {
...
//   static Future _onDidReceiveLocalNotificationIOS(int id, String? title, String? body, String? payload) async {
//     if (payload != null) {
//       debugPrint('notification payload: $payload');
//       List data = payload.split(',');
//       if (PrefUtils.getId().isNotEmpty) {
...
//     try {
//       _flutterLocalNotificationsPlugin.show(Platform.isIOS ? newNotificationId : 0, message.notification?.title ?? '', message.notification?.body ?? '', _notificationDetails, payload: '$id,$type');
//     } catch (e) {
