...
class PickImageCubit extends Cubit<PickImageState> {
  ...
  Future<void> pickImage({CropStyle? cropStyle, CropAspectRatioPreset? cropAspectRatioPreset}) async {
  ...
  Future<void> pickMultipleImage({CropStyle? cropStyle, CropAspectRatioPreset? cropAspectRatioPreset}) async {
